...
module.exports = {
    ...
    run:async(interaction, client) => {
        ...
        if (customId.endsWith("_mpmodal")) {
            ...
            // Verificação do comprimento do texto inserido
            if (text.length > 1000) {
                console.log("Texto de entrada muito longo:", text.length);
                return interaction.reply({ content: "Erro: o comprimento do texto excede o limite permitido.", ephemeral: true });
            }
        
            // Armazenando o novo token de acesso
            await bot.set('acesstoken', text);
            mp();
        }
        
        // Verificação do comprimento do customId
        if (customId && customId.length > 100) {
            console.log("customId muito longo:", customId.length);
        }
        ...
        if(customId.endsWith("_pixconfig")){
            ...
            .setCustomId("text")
            .setRequired(true)
            .setPlaceholder("bloxshop@gmail.com");
            ...
            interaction.update({
                ...
                components:[
                    ...
                    .addComponents(
                        ...
                        .setPlaceholder("Escolha qual cargo poderá aprovar as compras")
                        .setMaxValues(1)
                    ),
                    new ActionRowBuilder()
                    .addComponents(
        ...
        if(customId.endsWith("_channels")) {
            ...
            interaction.update({
                embeds:[
                    new EmbedBuilder()
                        .addFields(
                            { name: `Escolha o Canal de Logs Secretas`, value: `Canal Atual: (${channel})`, inline: false }
                        )
                ...
                components:[
                    ...
                    .addComponents(
                        ...
                        .setMaxValues(1)
                        .setPlaceholder("Selecione o Canal de Logs Secretas")
                    ),
                    new ActionRowBuilder()
                    .addComponents(
                        new ButtonBuilder()
        ...
        if(customId.endsWith("_categorys")) {
            ...
            interaction.update({
                embeds:[
                    new EmbedBuilder()
                    .addFields(
                        { name: `Escolha Categoria de Vendas`, value: `Categoria Atual: (${channel})`, inline: false }
                    )
                    .setColor(color)
                ],
                components:[
        ...
        if(customId.endsWith("_roles")) {
            ...
            interaction.update({
                embeds:[
                    new EmbedBuilder()
                    .addFields(
                        { name: `Escolha o Cargo de Cliente`, value: `Cargo Atual: (${channel})`, inline: false }
                    )
                    .setColor(color)
                ],
                components:[
        ...
        if(customId.endsWith("_channelspublic")) {
                const channel = interaction.guild.channels.cache.get(await bot.get("channel_public")) || "`Não Definido`";
            ...
            interaction.update({
                ...
                embeds:[
                    new EmbedBuilder()
                    .addFields(
                        { name: `Escolha o Canal de Logs Públicas`, value: `Canal Atual: (${channel})`, inline: false }
                    )
                    .setColor(color)
                ],
                components: [
        ...
        function payments() {
            interaction.update({
                embeds:[
                    ...
                    .setDescription(`Qual das formas de pagamento abaixo você deseja configurar?`)
                ],
                components:[
                    new ActionRowBuilder()
                    .addComponents(
